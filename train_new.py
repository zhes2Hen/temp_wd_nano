# train with simple weight decay
"""
...
"""elif init_from == 'resume':
    ...
    ckpt_path = os.path.join(out_dir, f'ckpt_wd{weight_decay}.pt')
    ...
    if iter_num % eval_interval == 0 and master_process:
        ...
        if losses['val'] < best_val_loss or always_save_checkpoint:
            ...
            if iter_num==max_iters: # only save checkpoint in the last iter
                ...
                torch.save(checkpoint, os.path.join(out_dir, f'ckpt_wd{weight_decay}.pt'))
